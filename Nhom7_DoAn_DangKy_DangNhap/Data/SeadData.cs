...
namespace Nhom7_DoAn_DangKy_DangNhap.Data
{
        ...
        public static void Initialize(IServiceProvider serviceProvider)
        {
                ...
                serviceProvider.GetRequiredService<DbContextOptions<Nhom7_DoAn_DangKy_DangNhapContext>>()))
            {
                ...
                if (!context.NguoiDung.Any())
                {
                 ...
                 {
                     new NguoiDung{MaNguoiDung = "ND01",HoTen = "Nguyễn Gia Huy",Email = "huy246@gmail.com",SDT = "0901234567",VaiTro= "KhachHang"},
                     new NguoiDung{MaNguoiDung = "ND02",HoTen = "Trần Thị Loan",Email = "loantran@gmail.com", SDT = "0912345678", VaiTro = "KhachHang"},
                     new NguoiDung{MaNguoiDung = "ND03",HoTen = "Lê Văn An",Email = "vanan@gmail.com",SDT = "0923456789",VaiTro = "KhachHang"},
                     new NguoiDung{MaNguoiDung = "ND04",HoTen = "Nguyễn An Hải Đường",Email = "haiduong707@gmail.com", SDT = "0934567890", VaiTro = "KhachHang" },
                     new NguoiDung{MaNguoiDung = "ND05",HoTen = "Hoàng Phương Hải Chi", Email = "haichi0710@gmail.com", SDT = "0923456366", VaiTro = "NhanVien" },
                     new NguoiDung{MaNguoiDung = "ND06",HoTen = "Nguyễn Hoàng Nhật Minh", Email = "minhnguyen113@gmail.com", SDT = "0324567890", VaiTro = "NhanVien" }
                 };
    ...
    {
        new TaiKhoan { TenDangNhap = "nhanvien1", MatKhau = "123456", VaiTro = "NhanVien",  IsLocked = false, MaNguoiDung = "ND05" },
        new TaiKhoan { TenDangNhap = "nhanvien2", MatKhau = "123456", VaiTro = "NhanVien",  IsLocked = false, MaNguoiDung = "ND06" }
    };
